...
\begin{figure}[htb]
	\centering
	\includegraphics[height=8cm]{../notebookit/metrics_demo.pdf}
	\caption{Demo metriikoiden visualisoinnista \ref{metrics_A}}
	\label{demo}
\end{figure}
...
\begin{table*}[!ht]
	\csvreader[%
	 tabular={|c|c|c|c|c|c|},
					...
					]{../tables/aggregated_A_metrics.csv}{model_name=\mname,WAIC=\waic}%
					{\mname & \waic}
				 \centering
					\caption{\label{metrics_A}Metriikoiden tulokset}
	\end{table*}
